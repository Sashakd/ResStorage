...
__declspec(dllimport) int __cdecl get_num_cnt(FILE* f);
__declspec(dllimport) int* __cdecl read_i_arr(FILE* f, int n);
__declspec(dllimport) void __cdecl print_i_arr(int* bg, int* nd);
__declspec(dllimport) int __cdecl num_if_in_cnt(int* bg, int* nd, int num);
__declspec(dllimport) int __cdecl get_diff_num_cnt(int* bg, int* nd);
